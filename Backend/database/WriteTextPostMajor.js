...
const write_post_major_router=express.Router();
...
write_post_major_router.get("/api/writepostmajor/:content/:major_id/:std_id", async (req,res) =>{
...
export { write_post_major_router};
